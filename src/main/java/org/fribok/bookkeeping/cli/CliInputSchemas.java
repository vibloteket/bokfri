...
final class CliInputSchemas {
    ...
    @Command(name = "schema", description = "Print the generated company input JSON Schema")
    static final class Company extends JsonSchemaCommand { Company() { super("company", CompanyInput.class); } }

    @Command(name = "schema", description = "Print the generated accounting-year input JSON Schema")
    static final class Year extends JsonSchemaCommand { Year() { super("year", AccountingYearInput.class); } }

    @Command(name = "schema", description = "Print the generated opening-balance input JSON Schema")
    ...
    @Command(name = "schema", description = "Print the generated customer input JSON Schema")
    static final class Customer extends JsonSchemaCommand { Customer() { super("customer", CustomerInput.class); } }

    @Command(name = "schema", description = "Print the generated product input JSON Schema")
    static final class Product extends JsonSchemaCommand { Product() { super("product", ProductInput.class); } }

    @Command(name = "schema", description = "Print the generated supplier input JSON Schema")
    static final class Supplier extends JsonSchemaCommand { Supplier() { super("supplier", SupplierInput.class); } }

    @Command(name = "schema", description = "Print the generated supplier-invoice input JSON Schema")
    ...
    @Command(name = "schema", description = "Print the generated supplier-credit input JSON Schema")
