...
public class SSTenderPanel {
    ...
    public SSTenderPanel(final SSDialog iOwner) {
        ...
        iCustomer.addSelectionListener(
            ...
            public void selected(SSCustomer selected) {
                if (selected != null) {
                    ...
                    iTender.setCurrencyRate(
                            selected.getInvoiceCurrency() == null
                                    ? new BigDecimal(1)
                                    : selected.getInvoiceCurrency().getExchangeRate());
        ...
        iCurrencyCalculatorButton.addActionListener(
                e -> {
                        ...
                        SSExchangeRateDialog.showDialog(iOwner, iTender, iCompanyCurrency,
    ...
    public boolean isValid() {
        ...
        return SSValidationDialog.showIfInvalid(iPanel, "Offerten", java.util.List.of("Giltig kund och kundnamn krävs."));
    }
    ...
    public void setTender(SSTender pTender) {
        ...
        iUseInvoiceForDelivery.setSelected(
                iTender.getDeliveryAddress().equals(iTender.getInvoiceAddress()));
    ...
    public void addKeyListeners() {
        ...
        iDate.getEditor().getComponent(0).addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                    SwingUtilities.invokeLater(() -> iExpires.getEditor().getComponent(0).requestFocusInWindow());
                }
            }
        });
