...
public class SSInterestInvoiceTableModel extends SSDefaultTableModel<SSInvoice> {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        case 8:
            value = SSInvoiceMath.getInterestSum(iInvoice,
                    ...
                    SSInvoiceMath.getNumDelayedDays(iInvoice));
            break;
    ...
    public List<SSInvoice> getInterestInvoices(String iDescription, SSAccount iAccount) {
        ...
        for (SSInvoice iInvoice : getObjects()) {
            ...
            if (iAction == InterestAction.SKIP) {
                continue;
            }
    ...
    private enum InterestAction implements SSTableSearchable {
        SKIP      ("interestinvoice.action.1"), INVOICE   ("interestinvoice.action.2"), OBLITERATE("interestinvoice.action.3");
        ...
        public String toString() {
            ...
            sb.append(
                    "se.swedsoft.bookkeeping.gui.invoice.util.SSInterestInvoiceTableModel.InterestAction");
