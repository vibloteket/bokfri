...
### Added
- The CLI can preview/import and export legacy `.xls` account plans, suppliers, vouchers, and
  voucher templates through GUI-independent Apache POI services, establishing the migration path
  away from JExcelAPI.
